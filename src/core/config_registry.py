...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "DASHSCOPE_API_KEYS": {
        "title": "DashScope API Keys",
        "description": "Comma-separated DashScope WebSearch API keys (Alibaba Cloud Bailian web search). Get key: https://dashscope.console.aliyun.com/",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
